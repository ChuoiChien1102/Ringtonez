...
class CategoryDetailViewController: ViewController {
    ...
    override func bindViewModel() {
        ...
        guard let viewModel = viewModel as? CategoryDetailViewModel else { return }
        
        //Input
        let inputs = CategoryDetailViewModel.Input(
