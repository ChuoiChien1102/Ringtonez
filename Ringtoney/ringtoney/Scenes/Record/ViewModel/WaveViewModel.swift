...
final class WaveViewModel {
    ...
    init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(WaveViewModel.didReceiveMeteringLevelUpdate),
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(WaveViewModel.didFinishRecordOrPlayAudio),
