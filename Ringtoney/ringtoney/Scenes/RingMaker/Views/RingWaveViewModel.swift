...
final class RingWaveViewModel {
    var audioVisualizationTimeInterval: TimeInterval = 0.02 // Time interval between each metering bar representation
    ...
    init() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(RingWaveViewModel.didReceiveMeteringLevelUpdate),
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(RingWaveViewModel.didFinishRecordOrPlayAudio),
